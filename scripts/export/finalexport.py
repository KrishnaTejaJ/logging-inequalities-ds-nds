...
def finalcalc():
	...
	for repo, repodata in pattern_data.items():
		...
		final_list.append([final[repo]['Type'], repo, final[repo]['Repo Link'], logcount[repo]['logging'], logcount[repo]['trace-traceback'], logcount[repo]['stderr'], logcount[repo]['print'], logcount[repo]['io-file.write']])
